...
import ClubSearchItemTest from '@/stories/test/components/club-search-item-test';

const meta: Meta<typeof ClubSearchItemTest> = {
  title: 'test/ClubSearchItemTest',
  component: ClubSearchItemTest,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
export default meta;
type Story = StoryObj<typeof ClubSearchItemTest>;
