...
const faqData: FAQItem[] = [
  ...
  {
    question: '동아리장을 변경하고 싶어요.',
    answerTitle:
      '아래의 구글폼을 통해 요청해주시면 됩니다. 빠른 시일 내에 권한을 승인해드리겠습니다.',
    answerBody:
      '[필수 입력 항목]\n\n1. 동아리명\n2. 기존 동아리장 학번\n3. 변경할 동아리장 학번\n\n[구글폼 링크]\n\nhttps://docs.google.com/forms/d/1U3tnUQxdu8CtT9W1b8KQoQkhFs851BiwSO3l355L57w/viewform?edit_requested=true',
  },
];
