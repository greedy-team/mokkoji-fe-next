...
function AdminHeader() {
  return (
    <>
      <ScrollProgressBar />
      <header className="fixed top-0 right-0 left-0 z-50 flex h-[60px] items-center gap-2 px-4 text-base font-medium text-white sm:gap-4 sm:px-8 lg:gap-6 lg:px-[150px]">
        <Link
          href="/"
