...
function BugInfoButton() {
  return (
    <Link
      ...
      className="fixed right-6 bottom-52 z-50 flex h-[80px] w-[80px] cursor-pointer flex-col items-center justify-center gap-1 gap-2 rounded-full bg-gradient-to-br from-[#4AF38A] via-[#4AF38A] via-40% to-[#32E2D0] text-xs lg:bottom-10 lg:h-[120px] lg:w-[120px] lg:text-base"
    >
