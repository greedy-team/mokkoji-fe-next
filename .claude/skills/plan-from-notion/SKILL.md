...
- 계획·구현 요청만으로 Notion 원문 수정, 체크 완료, 댓글 게시, 이슈·PR 생성, 푸시를 수행하지 않는다. 로컬 커밋은 CLAUDE.md와 [`/commit`](../../commands/commit.md)을 따른다.
...
- 이슈 생성은 요청받은 경우에만 [`/create_issue`](../../commands/create_issue.md)로 연결한다. 이슈나 Notion 쓰기를 로컬 구현의 필수 조건으로 만들지 않는다.
