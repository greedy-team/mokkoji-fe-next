...
function NavButton({ label, navProps, href, onItemClick }: NavButtonProps) {
  ...
  return (
    <Link
      ...
      onClick={onItemClick}
      className={clsx(
        'z-[70] mx-1 flex h-full items-center px-2 no-underline transition-colors duration-500 lg:mx-1 lg:px-2 lg:py-2',
        navProps,
        active
          ? 'ml-2 border-black font-extrabold lg:ml-0 lg:border-b-3'
